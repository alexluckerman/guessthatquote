...
function GroupMe(client_id, groupId) {
    this.auth = new URL(window.location).searchParams.get("access_token");
        ...
        console.log(groupId);
    this.groupId = (typeof groupId != "undefined" ? groupId : window.localStorage.getItem("GroupMe_groupId"));
...
var storage, prog, messagesViewed;
...
function startInit() {
    ...
    var gm = new GroupMe("ZDxIRTOlmsiv6iOwlmLextWonlTK5vGqB6rWI8J2dnJfkiRB");
    displayGroups(gm);
}
